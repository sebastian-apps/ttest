...
Great for hypothesis testing, calculating the positive predictive value, and plotting the receiver operating characteristic (ROC) and precision-recall (PR) curves.
