...
Welch's t-test can also be used for the evaluation of binary classifiers, such as those used in medical testing and machine learning. Binary classifiers distinguish between two states such as cancer "detected" and "not detected", or the flight is "delayed" and "not delayed".
